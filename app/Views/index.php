...
<body>
    ...
    <div class="container d-flex justify-content-center pt-4 flex-wrap">
        <?php foreach ($hasil as $a) : ?>
            <div class="card bg-dark text-white mb-4 mx-2 shadow" style="width: 18rem;">
                <div class="card-body">
                    <div class="card-image">
                        <img src="/img/<?= $a['gambar']; ?>" class="img-thumbnail" alt="">
                    </div>
                    <h5 class="card-title fs-3"><?= $a['nama_barang']; ?></h5>
                    <div class="card-text"><?= $a['spesifikasi']; ?></div>
                    <div><?= $a['kondisi']; ?></div>
                    <div><?= $a['lokasi']; ?></div>
                    <div><?= $a['jumlah_barang']; ?></div>
                    <a href="/detail/<?= $a['id_barang']; ?>" class="btn btn-primary mt-2 rounded-pill">Detail
            ...
            <form action="/tambah" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="spesifikasi" class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="jumlah_barang" class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">sumber_dana</label>
                        <input type="text" name="sumber_dana" class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="mb-3">
